    ...
    <>
      ...
      >
        <div className="certificate-1-container2 thq-section-max-width">
          <div className="certificate-1-thq-image-container-elm">
            {activeTab === 0 && (
              <img
                alt="OFICE"
          ...
          <div className="certificate-1-thq-tabs-menu-elm">
            <div
              onClick={() => setActiveTab(0)}
              className="certificate-1-thq-tab-horizontal-elm1"
            >
              <div className="certificate-1-thq-divider-container-elm1">
                {activeTab === 0 && (
                  <div className="certificate-1-container3"></div>
                )}
              </div>
              <div className="certificate-1-thq-content-elm">
                <h2 className="thq-heading-2 certificate-1-thq-feature1-title-elm">
                  <span
                ...
                <span className="thq-body-small certificate-1-thq-feature1-description-elm">
                  <span
                    dangerouslySetInnerHTML={{
            ...
            <div
              ...
              className="certificate-1-thq-tab-horizontal-elm2"
            >
              <div className="certificate-1-thq-divider-container-elm2">
                {activeTab === 1 && (
            ...
            <div
              ...
              className="certificate-1-thq-tab-horizontal-elm3"
            >
              <div className="certificate-1-thq-divider-container-elm3">
                {activeTab === 2 && (
      ...
      <style jsx>
        {`
          ...
          .certificate-1-thq-image-container-elm {
            height: 100%;
            display: flex;
            position: relative;
          }
          ...
          .certificate-1-thq-tabs-menu-elm {
          ...
          .certificate-1-thq-tab-horizontal-elm1 {
            gap: var(--dl-layout-space-twounits);
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .certificate-1-thq-divider-container-elm1 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          .certificate-1-thq-tab-horizontal-elm2 {
            gap: var(--dl-layout-space-twounits);
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .certificate-1-thq-divider-container-elm2 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          .certificate-1-thq-tab-horizontal-elm3 {
            gap: var(--dl-layout-space-twounits);
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .certificate-1-thq-divider-container-elm3 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          @media (max-width: 767px) {
            ...
            .certificate-1-thq-feature1-title-elm {
              font-size: 25px;
            }
            .certificate-1-thq-feature1-description-elm {
              font-size: 12px;
            }
          }
